...
await message.client.sendMessage(message.jid, fs.readFileSync('./Abuser/Hi.webp'), MessageType.sticker, { mimetype: Mimetype.webp, quoted : message.data, ptt: false})
    }
const array = ['Sed','Hi']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
